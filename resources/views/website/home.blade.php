...
<aside class="ceo-image-wrapper" aria-label="CEO profile image">
    ...
    <section class="services-section">
        ...
        <div class="services-grid">
            ...
            <div class="service-card">
                ...
                <p>End-to-end visa support including documentation, lodgement, and interview preparation with a 98% success
                    rate.</p>
            </div>
            ...
            <div class="service-card">
                ...
                <p>We provide end-to-end settlement support, helping you adjust smoothly to your new environment. Our team
                    guides you with practical advice, paperwork, and local insights for a stress-free transition.</p>
            </div>
    ...
    <div class="journey-section">
        <div class="content-side">
            ...
            <p>
                <strong>OZ Connect</strong> is a premier educational consultancy dedicated to helping students achieve success in their international journeys. We specialize in providing comprehensive study materials, guidance, and mock tests for <strong>IELTS</strong> and <strong>PTE</strong> to ensure you reach your target scores. Unlock your global potential with OZ Connect.
            </p>
